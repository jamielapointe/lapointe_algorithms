...
template <typename type_T> class Dynamic_Array {
public:
  ...
  explicit Dynamic_Array(size_type capactiy) : capactiy_{capactiy} {

    head_ = allocate_new_space(capactiy);
    if (head_ == nullptr) {
